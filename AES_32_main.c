...
AES_KEY KEY;
AES_KEY *key = &KEY;
// unsigned char in[16] = {0x32, 0x43, 0xf6, 0xa8, 0x88, 0x5a, 0x30, 0x8d, 0x31, 0x31, 0x98, 0xa2, 0xe0, 0x37, 0x7, 0x34};
...
int main()
{
    ...
    AES_decrypt(out, deout, key);
    cycles2 = cpucycles();
    totalcycles2 += cycles2 - cycles1;

    }
    printf("cpu cycles of AES 32 ENC %10lld\n",totalcycles1/10000);
    printf("cpu cycles of AES 32 DEC %10lld\n",totalcycles2/10000);
...
int main()
{
    ...
    ofp = fopen("AES128(ECB)KAT.rsp", "w"); //Write할 파일 개방
    if (ifp == NULL)
    {
